<template>
    <div i="wechat-autoreply-added">        
        <div class="send-msg">
            <ul>
                <li :class="{active: msg_type === 1}" @click="msg_type = 1"><i class="icon ion-android-create"></i>文字</li>
                <li :class="{active: msg_type === 2}" @click="msg_type = 2"><i class="menu-con appmsg"></i>图文</li>
            ...
            <div class="msg-con" v-show="msg_type === 2">
                <div class="news-comb" v-show="news_ids.length > 0">
                    <div 
        ...
        <div class="mt20">
            ...
            <el-button @click="deleteResponse">删除回复</el-button>
        </div>
    ...
    export default{
        ...
        methods: {
            ...
            save: function(){
                ...
                tools.alert.loading();
                tools.ajax({
                    url: '/api/admin/wechat/responses',
                    ajaxData: ajaxData,
                    successFun: function (res) {
                        tools.alert.closeLoading();
